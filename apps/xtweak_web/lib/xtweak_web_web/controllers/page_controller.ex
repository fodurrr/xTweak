defmodule XTweakWebWeb.PageController do
  ...
  def home(conn, _params) do
    ...
    render(conn, :home, layout: {XTweakWebWeb.Layouts, :home}, form: form)
  end
  ...
  def subscribe(conn, %{"newsletter" => newsletter_params}) do
    ...
    case AshPhoenix.Form.validate(form, newsletter_params) |> AshPhoenix.Form.submit() do
      ...
      {:error, form} ->
        render(conn, :home, layout: {XTweakWebWeb.Layouts, :home}, form: to_form(form))
    end
  end

  def weather(conn, _params) do
    render(conn, :weather, layout: {XTweakWebWeb.Layouts, :app_page})
  end
end
